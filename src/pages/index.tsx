  ...
  return (
    <>
      <Head>
        ...
        <meta name="title" key="title" content="FitHub" />
        <meta
          key="description"
          name="description"
          content="View Github Stats"
        />

        {/* <!-- Open Graph / Facebook --> */}
        <meta property="og:type" content="website" />

        <meta property="og:title" key="og:title" content="FitHub" />
        <meta
          key="og:description"
        ...
        <meta property="twitter:title" key="twitter:title" content="FitHub" />
        <meta
...
Home.getInitialProps = async (ctx: NextPageContext) => {
  ...
  //@ts-ignore
  const login = (session?.user?.login as string) || "rauchg";
