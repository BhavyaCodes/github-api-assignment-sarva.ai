...
export default function UserProfilePage({
  ...
  return (
    <>
      <Head>
        {/* <!-- Primary Meta Tags --> */}
        <meta property="og:site_name" content={data.login} />
        <meta name="title" key="title" content={data.login} />
        <meta key="description" name="description" content={data.bio} />

        {/* <!-- Open Graph / Facebook --> */}
        <meta property="og:type" content="website" />

        <meta property="og:title" key="og:title" content={data.login} />
        <meta
          key="og:description"
        ...
        <meta
          ...
          content={data.login}
        />
        <meta key="og:image" property="og:image" content={data.avatar_url} />
        <meta
